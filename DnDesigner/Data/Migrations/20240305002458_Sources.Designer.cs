...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DnDesigner.Models.Effect", b =>
                {
                    ...
                    b.Property<int?>("GroupedEffectEffectId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("GroupedEffectEffectId");
            ...
            modelBuilder.Entity("DnDesigner.Models.Source", b =>
                {
            ...
            modelBuilder.Entity("DnDesigner.Models.GroupedEffect", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("GroupedEffect");
                });

            modelBuilder.Entity("DnDesigner.Models.ModifyArmorClass", b =>
                {
                    b.HasBaseType("DnDesigner.Models.Effect");
                    ...
                    b.HasDiscriminator().HasValue("ModifyArmorClass");
                });
            ...
            modelBuilder.Entity("DnDesigner.Models.ModifyAttribute", b =>
                {
                    ...
                    b.ToTable("Effects", t =>
                        {
                            t.Property("Value")
                                .HasColumnName("ModifyAttribute_Value");
                        });

                    b.HasDiscriminator().HasValue("ModifyAttribute");
                });

            modelBuilder.Entity("DnDesigner.Models.SetArmorClass", b =>
                {
                    b.HasBaseType("DnDesigner.Models.Effect");

                    b.Property<string>("ArmorClassFormula")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("NoArmor")
                        .HasColumnType("bit");

                    b.Property<bool>("NoShield")
                        .HasColumnType("bit");

                    b.Property<bool>("Override")
                        .HasColumnType("bit");

                    b.HasDiscriminator().HasValue("SetArmorClass");
                });
            ...
            modelBuilder.Entity("DnDesigner.Models.Effect", b =>
                {
                    ...
                    b.HasOne("DnDesigner.Models.GroupedEffect", null)
                        .WithMany("Effects")
                        .HasForeignKey("GroupedEffectEffectId");
